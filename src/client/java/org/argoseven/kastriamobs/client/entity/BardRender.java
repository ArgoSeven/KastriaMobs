...
public class BardRender extends ExtendedGeoEntityRenderer<Bard> {
    ...
    public BardRender(EntityRendererFactory.Context renderManager) {
        super(renderManager, new KastriaEntityModel<>("bard"));
        this.shadowRadius = DEFAULT_SHADOW_RADIUS;
    }

    @Override
    public RenderLayer getRenderType(Bard animatable, float partialTick, MatrixStack poseStack, 
    ...
    @Override
    public void renderEarly(Bard animatable, MatrixStack poseStack, float partialTick, 
                           VertexConsumerProvider bufferSource, VertexConsumer buffer, 
    ...
    @Override
    protected Identifier getTextureForBone(String boneName, Bard entity) {
        return null;
    }

    @Override
    protected ItemStack getHeldItemForBone(String boneName, Bard entity) {
    ...
    @Override
    protected BlockState getHeldBlockForBone(String boneName, Bard entity) {
        return null;
    }

    @Override
    protected void preRenderItem(MatrixStack matrixStack, ItemStack itemStack, String boneName, 
                                 Bard entity, IBone bone) {
    ...
    @Override
    protected void preRenderBlock(MatrixStack matrixStack, BlockState blockState, String boneName, Bard entity) {
    }
    ...
    @Override
    protected void postRenderBlock(MatrixStack matrixStack, BlockState blockState, String boneName, Bard entity) {
    }
}
